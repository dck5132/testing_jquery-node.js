	...
	$("ul[value='choice']").on("click", function(event) {
		...
		switch(target) {
			...
			case "cre-15":
				...
				break;
			case "cre-16":
				$(".img-3-4").attr({ src: "images/sample/Spring.jpg",
...
function resetText(inp1,inp2,inp3,inp4) {
    ...
    $(inp4).html('<a href="images/sample/Grass.jpg"><img src="images/sample/Grass.jpg" alt="Grass" class="img-3-4" /></a> <a href="images/sample/Leaf.jpg"><img src="images/sample/Leaf.jpg" alt="Leaf"  class="img-3-4"/></a> <a href="images/sample/Spring.jpg"><img src="images/sample/Spring.jpg" alt="Spring"  class="img-3-4"/></a> <a href="images/sample/Water.jpg"><img src="images/sample/Water.jpg" alt="Water"  class="img-3-4"/></a>');       
}
// Modal 4
